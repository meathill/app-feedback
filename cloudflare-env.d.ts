/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 55fb62139911d4d5f1089b2c668dbcea)
// Runtime types generated with workerd@1.20260401.1 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface Env {
    DB: D1Database;
    ASSETS: Fetcher;
    NEXT_PUBLIC_SITE_URL: 'https://feedback.meathill.com';
    NEXTJS_ENV: string;

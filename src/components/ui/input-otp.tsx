...
export function InputOTPGroup({
  ...
  return (
    <div className={cn('flex items-center gap-2', className)} data-size={size} data-slot="input-otp-group" {...props} />
  );
}
...
export function InputOTPSeparator({ className, ...props }: React.ComponentProps<'div'>): React.ReactElement {
  return (
    <Separator
      className={cn(
